package no.nav.foreldrepenger.abonnent.konfig;
...
public interface KonfigVerdiRepository {
     ...
     *
     * @param gruppe
     *            - spesifiser en gruppe, eventuelt {@link KonfigVerdiGruppe#INGEN_GRUPPE}
     * @param kode
     *            - spesifikk kode
     * @param dato
     *            - dato når verdien skal være gyldig for. Må alltid spesifiseres.
