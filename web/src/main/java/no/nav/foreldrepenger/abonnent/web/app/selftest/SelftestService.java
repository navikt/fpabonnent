...
public class SelftestService {
    ...
    private KjørSelftestTjeneste kjørSelftestTjeneste;
    ...
    public SelftestService(Selftests selftests) {
        ...
        this.kjørSelftestTjeneste = new KjørSelftestTjeneste();
    }

    // for enhetstester
    void setKjørSelftestTjeneste(KjørSelftestTjeneste kjørSelftestTjeneste) {
        this.kjørSelftestTjeneste = kjørSelftestTjeneste;
    }
