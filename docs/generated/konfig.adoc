...
|fpsakhendelser.v1.url|URL til FPSAK der det sjekkes om hendelser er relevante, og hvis så blir sendt|no.nav.foreldrepenger.abonnent.felles.fpsak.HendelseConsumer
