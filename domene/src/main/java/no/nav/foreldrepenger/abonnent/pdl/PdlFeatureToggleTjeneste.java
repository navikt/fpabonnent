...
public class PdlFeatureToggleTjeneste {
    ...
    private static final Set<Cluster> SKAL_KONSUMERE_PDL_AKTIVERT = Set.of(Cluster.LOCAL, Cluster.DEV_FSS);
    private static final Set<Cluster> SKAL_GROVSORTERE_PDL_AKTIVERT = Set.of(Cluster.LOCAL);
